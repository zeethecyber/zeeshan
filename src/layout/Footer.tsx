    ...
    <footer className="text-gray-1 py-20 max-w-7xl m-auto px-6">
      ...
      <div className="flex justify-between items-center mt-12">
        ...
        <div className="flex gap-6 md:gap-12">
          <Link href="https://github.com/Zeeshan044" target={"_blank"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <Link href="https://twitter.com/ZeeshanAsif01" target={"_blank"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <Link href="https://www.instagram.com/dear_zee_/" target={"_blank"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
